    ...
    <div class="container">
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
            ...
            <?php 
              include('koneksi.php');
              $ambil = mysqli_query($koneksi, "SELECT * FROM tambah_produk WHERE id_produk='$id_produk'");
      ...
      if(isset($_POST['konfirm'])) {
          ...
          $insert = mysqli_query($koneksi, "INSERT INTO daftar_pesanan (tanggal_pemesanan, total_belanja) VALUES ('$tanggal_pemesanan', '$totalbelanja')");
