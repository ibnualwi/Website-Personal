...
<html lang="en">
  ...
  <!-- Jumbotron -->
      <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
          ...
          <hr>
          <p class="lead font-weight-bold">Silahkan Pesan Pupuk Organik Sesuai Kebutuhan Anda <br> 
        </div>
      </div>
  <!-- Akhir Jumbotron -->
  ...
  <div class="container">
        <div class="judul text-center mt-5">
          <h3 class="font-weight-bold">PUPUK ORGANIK</h3>
          <h5>Jl. Tower, Mutiara, Kec. Kisaran Timur, Kab.Asahan.
        </h5>
        </div>
